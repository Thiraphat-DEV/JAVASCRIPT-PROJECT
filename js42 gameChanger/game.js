...
//เริ่มเกม
function startGame() {
    setInterval(increaseTime, 1500)//หลังจาก 1 วินาที่ ให้เวลาเริ่ม
}
...
function createVacine() {
    ...
    vacines.innerHTML = `<img src="${selected_vacine.src}" alt="${selected_vacine.alt}" style="transform: rotate(${Math.random() * 360}deg)" />`
