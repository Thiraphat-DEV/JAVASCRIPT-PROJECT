...
//function get data All
  function getDataAll() {
    ...
    excerpt.innerHTML ="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi deleniti et ex quidem quos maiores dolores quis cum neque in. Laboriosam fugit molestiae, necessitatibus nesciunt ipsam vel nisi libero error dicta mollitia modi incidunt dolorem repellendus repellat voluptatibus vitae quae.";
      profile.innerHTML = `<img src="https://randomuser.me/api/portraits/men/${random}.jpg" alt="/">`

      names.innerHTML = 'Thiraphat B.';
